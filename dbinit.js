...
function initializeDatabase(db) {
    return db.dropCollection("users")
             ...
             .then(_ => db.dropCollection("lists"))
             .catch(() => {})
             ...
             .then(_ => db.dropCollection("items"))
             .catch(() => {})
             ...
             .then(items => items.insertMany(
                 [{
                    ...
                    "__v": 0
                     ...
                     "reminderDate": null, "completionDate": new Date("2022-03-04T16:13:54.499Z"),
                     "tags": [],
                     "count": 1,
                     "remainingCount": 1,
                     "priority": false,
             ...
             .then(_ => db.dropCollection("notifications"))
             .catch(() => {})
             ...
             .then(_ => console.log("Connection with the database established"));
}

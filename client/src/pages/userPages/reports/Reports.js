...
import "./Reports.scss";
import ItemsChart from "../../../components/userPages/reports/itemsChart/ItemsChart";
import CompletionChart from "../../../components/userPages/reports/completionChart/CompletionChart";
import {SelectButton} from "primereact/selectbutton";
import EmptyPlaceholder from "../../../components/userPages/emptyPlaceholder/EmptyPlaceholder";
    ...
    return (
        <div className="grid h-screen">
            ...
            <div id="reportsMainMenuContainer" className="mx-0 p-0 hidden md:block">
                <SideMenu selected={ "Reports" } open={ true } />
            </div>

...
import CreateItemDialog from "./itemElement/createItemDialog/CreateItemDialog";
    ...
    useEffect(() => {
        function handleUpdates(event, eventListId) {
            if (list._id === eventListId
                && new RegExp(
                       "^itemElement(?:Created|(?:Title|DueDate|ReminderDate|Priority|Completion|Count)Changed|Tags(?:Added|Removed)"
